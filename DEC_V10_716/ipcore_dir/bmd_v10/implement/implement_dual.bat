...
echo 'Running ngdbuild'
  ngdbuild -verbose -uc ..\..\example_design\xilinx_dual_pci_exp_blk_plus_1_lane_ep_xc5vfx70t-ff1136-1.ucf xilinx_dual_pci_exp_ep.ngc -sd ..\..\..\
...
netgen -sim  -ofmt vhdl   -w  -tm xilinx_dual_pci_exp_ep routed.ncd
